...
const StudentRegisterPage = lazy(() => import("@/views/register/student/RegisterPage"));
const LecturerRegisterPage = lazy(() => import("@/views/register/lecturer/RegisterPage"));
...
const StudentGroupChatPage = lazy(() => import("./views/student/GroupChatPage"));
const StudentMessagesPage = lazy(() => import("@/views/student/MessagesPage"));
const LecturerMessagesPage = lazy(() => import("@/views/lecturer/MessagesPage"));
...
const StudentAssignmentsPage = lazy(() => import("@/views/student/AssignmentsPage"));
const LecturerCoursesPage = lazy(() => import("@/views/lecturer/CoursesPage"));
const CourseDetailPage = lazy(() => import("@/components/course/CourseDetailPage"));
const CourseManagePage = lazy(() => import("@/views/lecturer/CourseManagePage"));
const CourseMaterialsPage = lazy(() => import("@/components/course/CourseMaterialsPage"));
const CourseAssignmentsPage = lazy(() => import("@/components/course/CourseAssignmentsPage"));
const StudentAssignmentDetailPage = lazy(() => import("@/views/student/StudentAssignmentDetailPage"));
const LecturerAssignmentSubmissionsPage = lazy(() => import("@/views/lecturer/LecturerAssignmentSubmissionsPage"));
const LecturerAssignmentsPage = lazy(() => import("@/views/lecturer/AssignmentsPage"));
...
const StudentReportActivityPage = lazy(() => import("@/views/student/ReportActivityPage"));
const LecturerReportActivityPage = lazy(() => import("@/views/lecturer/ReportActivityPage"));
const ProfilePage = lazy(() => import("@/views/ProfilePage"));

// Lazy load development tools only in dev mode
const DevAuthDebugger = process.env.NODE_ENV === 'development' 
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/register/lecturer" element={
          <PublicRoute>
            <Suspense fallback={<PageLoader />}>
