...
export function Message({
  ...
  const canDelete =
    isLecturer || (currentUserId && message.senderId === currentUserId);
  ...
  const renderFileAttachment = () => {
    ...
    const fileUrl = `${API_CONFIG.BASE_URL}${fileAttachment.url}`;
        ...
        <div className="mt-2">
          ...
          <div className="text-xs text-gray-500 mt-1 flex items-center justify-between">
            ...
            <Button
              ...
              size="sm"
              onClick={() =>
                handleDownload(fileAttachment.url, fileAttachment.originalName)
              }
