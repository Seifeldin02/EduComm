...
export function GroupAvatar({
  ...
  if (imageUrl) {
    return (
      ...
      >
        ...
        />
        <div
          className={`absolute inset-0 items-center justify-center text-white font-medium hidden`}
        >
  ...
  return (
    <div
      className={`flex items-center justify-center rounded-md ${sizeClasses[size]} ${bgColor} text-white font-medium ${className}`}
    >
      {initials || <Image className="w-1/2 h-1/2 opacity-70" />}
    </div>
  );
